...
Para lograr ésto, desarrollamos 1 sketch y lo testeamos con 3 conserjes, junto a una breve entrevista.
Nuestras preguntas fueron:

(Preguntas previas al tema, tales como ¿Cómo se llama?, ¿Qué edad tiene?, ¿Qué hace? etc...)
--Entramos al tema--
¿Qué tipo de tecnología usa normalmente?
¿Qué tipo de registro utilizan?
¿Qué datos se piden?
¿Cuánto se demora en hacerlo?
--Se les pasa el sketch--
¿Qué haría usted para ingresar al usuario?
¿Qué haría usted para ver los datos del usuario?
¿Qué haría usted para borrar un usuario?
¿Cree que le sería útil ésta aplicación?
¿Qué le cambiaría usted?
